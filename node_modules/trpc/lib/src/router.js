    ...
    function TRPCRouter(def) {
        ...
        this.endpoint = function (path, endpt) {
            ...
            if (_this._def.children[path] || _this._def.endpoints[path])
                throw new _1.TRPCError(500, _1.TRPCErrorCode.NameConflict, {
                    message: "Name conflict: \"" + path + "\" already in use",
                });
            return new TRPCRouter({
                children: _this._def.children,
                endpoints: __assign({}, _this._def.endpoints, (_a = {}, _a[path] = endpt, _a)),
            });
        };
        this.compose = function (path, child) {
            ...
            return new TRPCRouter({
                children: __assign({}, _this._def.children, (_a = {}, _a[path] = child, _a)),
                endpoints: _this._def.endpoints,
            });
        };
        this.handle = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            var path, args, context, segment, maybeEndpoint, maybeChild, handler, isAuthorized, err_1, value, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!payload) {
                            throw new _1.TRPCError(500, _1.TRPCErrorCode.InvalidEndpoint, {
                        ...
                        if (!Array.isArray(path) || !path.every(function (x) { return typeof x === 'string'; })) {
                            throw new _1.TRPCError(400, _1.TRPCErrorCode.InvalidEndpoint, {
                                message: 'body.endpoint should be array of strings.',
                            });
                        }
                        if (!Array.isArray(args)) {
                            throw new _1.TRPCError(400, _1.TRPCErrorCode.InvalidArguments, {
                        ...
                        if (!maybeEndpoint && !maybeChild)
                            throw new _1.TRPCError(501, _1.TRPCErrorCode.EndpointNotFound, {
                                message: "Endpoint not found: \"" + segment + "\"",
                            });
                        if (!maybeChild) return [3 /*break*/, 2];
                        if (path.length < 2) {
                            throw new _1.TRPCError(501, _1.TRPCErrorCode.InvalidPath, {
                    ...
                    case 5:
                        err_1 = _a.sent();
                        if (err_1 instanceof _1.TRPCError) {
                            throw err_1;
                        }
                        throw new _1.TRPCError(500, _1.TRPCErrorCode.AuthorizationError, err_1.message);
                    case 6:
                        if (!isAuthorized) {
                            throw new _1.TRPCError(403, _1.TRPCErrorCode.NotAuthorized, {
                    ...
                    case 7:
                        _a.trys.push([7, 9, , 10]);
                        return [4 /*yield*/, handler.call.apply(handler, [context].concat(args))];
                    case 8:
                        value = _a.sent();
                        return [2 /*return*/, value];
                    case 9:
                        error_1 = _a.sent();
                        if (error_1 instanceof _1.TRPCError) {
                            throw error_1;
                        }
                        throw new _1.TRPCError(500, _1.TRPCErrorCode.UnknownError, {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (request.method !== 'POST') {
                            throw new _1.TRPCError(400, _1.TRPCErrorCode.InvalidMethod, {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        if (err_2 instanceof _1.TRPCError) {
                            return [2 /*return*/, response
                                    .status(err_2.code || 500)
                                    .send(err_2.type + ": " + err_2.message)];
                        }
