import url from 'url';
import { T as TRPCError, i as inputValidationError, d as deprecateTransformWarning, g as getErrorFromUnknown } from './once-a5ff19f1.esm.js';
...
class HTTPError extends TRPCError {
...
async function requestHandler(opts) {
  ...
  const reqQueryParams = req.query ? req.query : url.parse(req.url, true).query;
...
export { HTTPError as H, assertNotBrowser as a, getStatusCodeFromError as g, httpError as h, requestHandler as r };
