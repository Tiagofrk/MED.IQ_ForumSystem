import { DataTransformer, TRPCProcedureSuccessEnvelope, AnyRouter } from '@trpc/server';
...
export declare type OperationResult<TRouter extends AnyRouter, TOutput = unknown> = TRPCProcedureSuccessEnvelope<TOutput> | TRPCClientError<TRouter>;
export declare type PrevCallback<TRouter extends AnyRouter, TOutput = unknown> = (result: OperationResult<TRouter, TOutput>) => void;
