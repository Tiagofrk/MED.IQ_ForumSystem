...
import { T as TRPCClientError, r as retryDelay } from '../../../dist/createTRPCClient-4c16be1e.esm.js';
    ...
    return function (_ref) {
      ...
      var unsub = client.request({
        ...
        onDone: function onDone() {
          if (!unsubbed) {
            prev(TRPCClientError.from(new WebSocketInterruptedError('Operation ended prematurely'), {
              isDone: true
            }));
          }
        }
...
export { WebSocketInterruptedError, createWSClient, wsLink };
