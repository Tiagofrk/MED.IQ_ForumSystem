...
export declare function createSSGHelpers<TRouter extends AnyRouter>({ router, transformer, ctx, queryClientConfig, }: CreateSSGHelpersOptions<TRouter>): {
    ...
    fetchQuery: <TPath_2 extends keyof TRouter["_def"]["queries"] & string, TProcedure_2 extends TRouter["_def"]["queries"][TPath_2]>(path: TPath_2, ...args: inferHandlerInput<TProcedure_2>) => Promise<any>;
    fetchInfiniteQuery: <TPath_3 extends keyof TRouter["_def"]["queries"] & string, TProcedure_3 extends TRouter["_def"]["queries"][TPath_3]>(path: TPath_3, ...args: inferHandlerInput<TProcedure_3>) => Promise<import("react-query").InfiniteData<any>>;
