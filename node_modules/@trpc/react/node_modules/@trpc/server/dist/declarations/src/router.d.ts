...
export declare type inferHandlerInput<TProcedure extends Procedure> = TProcedure extends ProcedureWithInput<any, infer TInput, any> ? undefined extends TInput ? [(TInput | null | undefined)?] : [TInput] : [(undefined | null)?];
...
export declare type ErrorFormatter<TContext, TOutput extends {}> = ({ error, }: {
    error: TRPCError;
...
export declare type DefaultErrorShape = {
    message: string;
    code: string;
    path?: string;
    stack?: string;
...
export declare class Router<TContext, TQueries extends ProcedureRecord<TContext>, TMutations extends ProcedureRecord<TContext>, TSubscriptions extends ProcedureRecord<TContext, unknown, Subscription<unknown>>, TErrorShape extends ErrorShape> {
