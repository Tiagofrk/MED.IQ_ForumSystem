import { a as assertNotBrowser } from './index-1a4e8243.esm.js';
import { i as inputValidationError, a as getMessageFromUnkownError, n as notFoundError } from './once-a5ff19f1.esm.js';
...
class Procedure {
  ...
  parseInput(rawInput) {
    try {
      ...
      const message = getMessageFromUnkownError(originalError, 'Input Validation Error');
...
export { Router as R, router as r };
